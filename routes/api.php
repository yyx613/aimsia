...
Route::post('/sso/logout', 'App\Http\Controllers\Api\V2\SSOController@logout');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::any('khalti/payment/pay', 'App\Http\Controllers\Api\V2\PaypalController@pay')->name('api.khalti.url');
    Route::any('khalti/payment/success', 'App\Http\Controllers\Api\V2\PaypalController@getDone')->name('api.khalti.success');
    Route::any('khalti/payment/cancel', 'App\Http\Controllers\Api\V2\PaypalController@getCancel')->name('api.khalti.cancel');
